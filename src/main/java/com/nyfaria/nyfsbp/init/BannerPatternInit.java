...
public class BannerPatternInit {
    ...
    public static final DeferredRegister<BannerPattern> BANNER_PATTERNS = DeferredRegister.create(Registry.BANNER_PATTERN_REGISTRY, "nyfsbp");
    ...
    public static final RegistryObject<BannerPattern> PATTERN_MOON_GL = registerBannerPattern("pattern_moon_bl");
    public static final RegistryObject<BannerPattern> PATTERN_MOON_GR = registerBannerPattern("pattern_moon_br");
